...
/*   Updated: 2022/03/12 04:09:03 by melperri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
WrongAnimal::WrongAnimal() : Animal("WrongAnimal") {
	std::cout << GREEN_IT << "WrongAnimal default constructor called" << END_COLOR << std::endl;
	return ;
}

WrongAnimal::WrongAnimal(const WrongAnimal &wronganimal) : Animal(wronganimal) {
	std::cout << GREEN_IT << "WrongAnimal copy constructor called" << END_COLOR << std::endl;
	*this = wronganimal;
	return ;
}

WrongAnimal::~WrongAnimal() {
	std::cout << GREEN_IT << "WrongAnimal destructor called" << END_COLOR << std::endl;
	return ;
}
