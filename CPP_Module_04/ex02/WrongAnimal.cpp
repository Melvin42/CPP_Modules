...
/*   Updated: 2022/03/15 15:34:33 by melperri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "WrongAnimal.hpp"

WrongAnimal::WrongAnimal() : AAnimal("WrongAnimal") {
	std::cout << GREEN_IT << "WrongAnimal default constructor called"
		<< END_COLOR << std::endl;
	return ;
}

WrongAnimal::WrongAnimal(const WrongAnimal &wronganimal) : AAnimal(wronganimal) {
